...
const SearchQuestions = () => {
    ...
    const onSubmit = async event => {
        ...
        try {
            ...
            //     queston: res.data.queston,
            //     answera: res.data.answera,
            //     answerb: res.data.answerb,
            //     answerc: res.data.answerc,
            //     answerd: res.data.answerd,
...
//==================================================================================================================================
// Specifies the JSX that will be inserted into the DOM as HTML
//==================================================================================================================================
            ...
            <div className="sign-up-container ">
                ...
                <table className="table table-striped">
                    ...
                    <tbody>
                        <tr>
                        <th scope="row"></th>
                        <td>{this.questionData.topic}</td>
                        <td>{this.questionData.question}</td>
                        <td>{this.questionData.answera}</td>
                        <td>{this.questionData.answerb}</td>
                        <td>{this.questionData.answerc}</td>
                        <td>{this.questionData.answerd}</td>
                        </tr>
