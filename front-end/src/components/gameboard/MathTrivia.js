...
export default class MathTrivia extends React.Component {
    state = {
        point: 0,
    ...
    //=================================================================================
      ...
      componentDidMount() {
        ...
        getQuestions = async event => {
            ...
            try {
              const res = await axios.get(`/api/searchquestions/${this.state.Mathematics}`);
                                            ...
                                            <Table.Row>
                                                <Table.Cell>
                                                    <RandomNumber handleIncrement={this.handleIncrement}>
                                                        <img src={MathTri} alt="math" width="75" height="75"/>
                                                    </RandomNumber>
                                                </Table.Cell>
