...
import SoStu from "../../images/socialstudies.jpg";
...
export default class SocialStudies extends React.Component {
    state = {
        point: 0,
    ...
    componentDidMount() {
      ...
      getQuestions = async event => {
          ...
          try {
            const res = await axios.get(`/api/searchquestions/${this.state.USHistory}`);
                                            ...
                                            <Table.Row>
                                                <Table.Cell>
                                                    <RandomNumber handleIncrement={this.handleIncrement}>
                                                        <img src={SoStu} alt="sostu" width="75" height="75"/>
                                                    </RandomNumber>
                                                </Table.Cell>
